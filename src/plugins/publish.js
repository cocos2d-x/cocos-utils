...
function run(currDir, args, opts){
    ...
    var emPath = path.relative(htmlDir, path.join(projDir, engineDir, "cocos2d-html5/src/cc4publish.js")).replace(/\\/g, "/");
    ...
    build(allJsList, function(err){
//        if(cfg.delTemp) core4cc.rmdirRecursive(tempDir);
    });
};
